...
import { QuizScore, VocabWord } from '../../types';
...
export default function ProgressPage() {
  ...
  return (
    <Layout
      ...
      subtitle='Theo dõi quá trình học tập và thành tích của bạn'
    >
      {progressData && (
        <>
          {/* Overview Cards */}
          ...
          <div className='bg-white rounded-xl shadow-lg p-6 mb-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
              ...
              <div className='p-4 bg-blue-50 rounded-lg'>
                <p className='text-sm text-gray-600 mb-1'>Mục tiêu hàng ngày</p>
